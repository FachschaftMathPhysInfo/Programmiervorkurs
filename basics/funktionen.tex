...
\begin{center}
	\texttt{double my\_func(double x, int n)}
\end{center}
...
Der Funktionsrumpf beinhaltet den Code, der beim Funktionsaufruf tatsächlich ausgeführt hat und beginnt mit \{ und endet mit \}.
In diesem kann auf die Parameter einfach mit dem in der Signatur definierten Namen zugegriffen werden.
