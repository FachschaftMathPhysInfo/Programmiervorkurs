...
\input{lektionen/variables_datatypes}
\input{lektionen/arithmetics}
\input{lektionen/control_flow}
\input{lektionen/loops}
\input{lektionen/debbugging}
\input{lektionen/functions}
\input{lektionen/stdlib}
\input{lektionen/arrays_vectors}
\input{lektionen/recursion} 
\input{lektionen/errors_warnings}
\input{lektionen/tictactoe}
\input{lektionen/exercises/intro} %ToDo, also needs to bed added
